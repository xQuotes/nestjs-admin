...
let DefaultAdminController = class DefaultAdminController {
    ...
    executeListAction(request, listActionIndex, params, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const { adminEntity, section, metadata } = yield this.getAdminModels(params);
            const listAction = adminEntity.listActions[listActionIndex].action;
            const boundedListAction = listAction.bind(adminEntity);
            yield boundedListAction(request, response);
            return response.redirect(urls.changeListUrl(section, metadata));
        });
    }
    executeChangeAction(request, changeActionIndex, params, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const { adminEntity, section, metadata, entity } = yield this.getAdminModels(params);
            ...
            yield boundedChangeAction(entity, request, response);
...
__decorate([
    common_1.Post(':sectionName/:entityName/action'),
    __param(0, common_1.Req()),
    __param(1, common_1.Body('listActionIndex')),
    __param(2, common_1.Param()),
    __param(3, common_1.Response()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number, Object, Object]),
    __metadata("design:returntype", Promise)
], DefaultAdminController.prototype, "executeListAction", null);
__decorate([
    common_1.Post(':sectionName/:entityName/:primaryKey/action'),
    __param(0, common_1.Req()),
    __param(1, common_1.Body('changeActionIndex')),
    __param(2, common_1.Param()),
    __param(3, common_1.Response()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number, Object, Object]),
    __metadata("design:returntype", Promise)
], DefaultAdminController.prototype, "executeChangeAction", null);
DefaultAdminController = __decorate([
    common_1.Controller('adminUser'),
