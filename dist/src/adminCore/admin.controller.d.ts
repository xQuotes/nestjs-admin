...
export declare class DefaultAdminController {
    ...
    executeListAction(request: Request, listActionIndex: number, params: AdminModelsQuery, response: express.Response): Promise<void>;
    executeChangeAction(request: Request, changeActionIndex: number, params: AdminModelsQuery, response: express.Response): Promise<void>;
}
export {};
