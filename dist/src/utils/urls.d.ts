...
export declare function listActionUrl(section: AdminSection, metadata: EntityMetadata): string;
export declare function changeUrl(section: AdminSection, metadata: EntityMetadata, entity: object): string;
export declare function changeActionUrl(section: AdminSection, metadata: EntityMetadata, entity: object): string;
